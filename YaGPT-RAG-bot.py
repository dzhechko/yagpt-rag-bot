...
def main():
    ...
    st.warning('Загружайте свои PDF-файлы и задавайте вопросы по ним. Если вы уже загрузили свои файлы, то <u>обязательно</u> удалите их из списка загруженных и переходите к чату ниже.')
    ...
    mdb_os_hosts = st.sidebar.text_input("MDB_OpenSearch_HOSTS через 'запятую' ").split(",")
